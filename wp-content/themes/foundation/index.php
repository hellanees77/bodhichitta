...
get_header(); ?>
    <div class="owl-carousel slide-one-item">
      <a href="#"><img src="<?php bloginfo('template_url'); ?>/images/kid.jpg" alt="Image" class="img-fluid"></a>
      <a href="#"><img src="<?php bloginfo('template_url'); ?>/images/kusum.jpeg" alt="Image" class="img-fluid"></a>
      <a href="#"><img src="<?php bloginfo('template_url'); ?>/images/children.jpeg" alt="Image" class="img-fluid"></a>
    </div>
          ...
          <div class="col-lg-6 mb-4">
            <figure class="block-img-video-1" data-aos="fade">
              <a href="https://vimeo.com/45830194" class="popup-vimeo">
                ...
                <img src="<?php bloginfo('template_url'); ?>/images/hero_1_no-text.jpg" alt="Image" class="img-fluid">
              </a>
            </figure>
          </div>
      ...
      <div class="container">
        ...
        <div class="row mb-5">
          ...
          <div class="col-lg-6 mb-5">
            <img src="<?php bloginfo('template_url'); ?>/images/kidd.jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-lg-5 ml-auto align-self-center">
            <h3 class="text-black text-uppercase mb-4">Build Schools in Nepal</h3>
        ...
        <div class="row mb-5">
          ...
          <div class="col-lg-6 mb-5 order-lg-2">
            <img src="<?php bloginfo('template_url'); ?>/images/nepal.jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-lg-5 mr-auto align-self-center order-lg-1">
            <h3 class="text-black text-uppercase mb-4">Feeding Children in Nepal</h3>
            <p class="mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam quis, nemo explicabo cupiditate vero fugiat sit eius sequi.</p>
    ...
    <div class="site-section bg-image overlay" style="background-image: url('<?php bloginfo('template_url'); ?>/images/hero_1_no-text.jpg');" id="donate-section">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0" data-aos="fade-up">
            <div class="block-team-member-1 text-center rounded">
              <figure>
                <img src="<?php bloginfo('template_url'); ?>/images/person_1.jpg" alt="Image" class="img-fluid rounded-circle">
              </figure>
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0" data-aos="fade-up" data-aos-delay="100">
            <div class="block-team-member-1 text-center rounded">
              <figure>
                <img src="<?php bloginfo('template_url'); ?>/images/person_2.jpg" alt="Image" class="img-fluid rounded-circle">
              </figure>
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0" data-aos="fade-up" data-aos-delay="200">
            <div class="block-team-member-1 text-center rounded">
              <figure>
                <img src="<?php bloginfo('template_url'); ?>/images/person_3.jpg" alt="Image" class="img-fluid rounded-circle">
              </figure>
    ...
    <div class="site-section block-13 overlay bg-image" id="testimonials-section" data-aos="fade" style="background-image: url('<?php bloginfo('template_url'); ?>/images/hero_1_no-text.jpg');">
      <div class="container">
        ...
        <div class="owl-carousel nonloop-block-13">
          <div>
            <div class="block-testimony-1 text-center">
              ...
              <figure>
                <img src="<?php bloginfo('template_url'); ?>/images/person_4.jpg" alt="Image" class="img-fluid rounded-circle mx-auto">
              </figure>
              <h3 class="font-size-20 text-white">Ricky Fisher</h3>
            </div>
          </div>
          ...
          <div>
            <div class="block-testimony-1 text-center">
              ...
              <figure>
                <img src="<?php bloginfo('template_url'); ?>/images/person_2.jpg" alt="Image" class="img-fluid rounded-circle mx-auto">
              </figure>
          ...
          <div>
            <div class="block-testimony-1 text-center">
              ...
              <figure>
                <img src="<?php bloginfo('template_url'); ?>/images/person_1.jpg" alt="Image" class="img-fluid rounded-circle mx-auto">
              </figure>
          ...
          <div>
            <div class="block-testimony-1 text-center">
              ...
              <figure>
                <img src="<?php bloginfo('template_url'); ?>/images/person_3.jpg" alt="Image" class="img-fluid rounded-circle mx-auto">
              </figure>
    ...
    <div class="site-section" id="blog-section">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <div>
              <a href="single.html" class="mb-4 d-block"><img src="<?php bloginfo('template_url'); ?>/images/hero_1_no-text.jpg" alt="Image" class="img-fluid rounded"></a>
          ...
          <div class="col-lg-6">
            <div>
              <a href="single.html" class="mb-4 d-block"><img src="<?php bloginfo('template_url'); ?>/images/hero_2_no-text.jpg" alt="Image" class="img-fluid rounded"></a>
              <h2><a href="single.html">How to Invest In Investing Company</a></h2>
              <p class="text-muted mb-3 text-uppercase small"><span class="mr-2">January 18, 2019</span> By <a href="single.html" class="by">James Cooper</a></p>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quaerat et suscipit iste libero neque. Vitae quidem ducimus voluptatibus nemo cum odio ab enim nisi, itaque, libero fuga veritatis culpa quis!</p>
